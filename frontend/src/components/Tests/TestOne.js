...
const TestOne = ({ isLoaded }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (parseInt(option) === 10 || parseInt(option) === 15) {
    ...
    return (
        <div className='ind-test'>
            ...
            <div className='test-img-vertical' style={{ backgroundImage: `url(${test1Image})` }}></div>
